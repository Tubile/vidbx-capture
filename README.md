...
Locked capture page for one business. Intake copies this folder, fills slots, and runs it. Do not rewrite the HTML/JS/CSS.

## Setup

1. Copy this folder (do not put customer captures in it).
